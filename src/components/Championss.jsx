...
const Championss = () => {
  return (
    <div>
         <Helmet>
          <title>أكاديميات الإتحاد الفلسطيني للشراع و التجديف</title>
          <meta name='description' content='توقيع شراكة الإتحاد الفلسطيني للشراع و التجديف مع أكاديمية تشامبيون لتأسيس أكاديمية تجديف'></meta>
          <link rel='canonical' href='/champions'></link>
        </Helmet>
...
{/* <!-- Subheader --> */}
<div id="inner_header"class="champions bg-overlay" data-parallax="scroll" data-image-src="assets/images/أكاديميات/تشامبيون.jpg">
<div class="container">
<div class="inner_intro">
  <h1>أكاديمية تشامبيون</h1>
  </div>
</div>
</div>
{/* <!-- /Subheader -->
   ...
   <div class="container">
      <div class="row">
        <div class="col-lg-8">
          ...
          <h4>توقيع الاتحاد الفلسطيني للشراع والتجديف اتفاقية شراكة مع مجموعة تشامبيون</h4>
          <p>جانب من توقيع رئيس الاتحاد الفلسطيني للشراع والتجديف السيد خلدون ابوسليم  اتفاقية شراكة مع مجموعة تشامبيون لتأسيس اكاديمية التجديف بحضور السيد معاوية القواسمي عضو المكتب التنفيذي في اللجنة الاولمبية الفلسطينية والدكتور اسعد المجدلاوي نائب رئيس اللجنة الاولمبية الفلسطينية وممثلين عن بنك فلسطين الشريك الاستراتيجي مع الاتحاد 
           وشارك من مجموعة تشامبيون السيد رجب السرّاج رئيس مجلس إدارة المجموعة  والسيد محمود شرف نائب رئيس مجلس الادارة  الذين عبّروا  عن شكرهم للجنة الأولمبية الفلسطينية والاتحاد الفلسطيني للشراع والتجديف على توقيع هذه الاتفاقية الهامة، مؤكداً أن مجموعة تشامبيون أبوابها دائما مفتوحة لاستضافة جميع الاتحادات الفلسطينية والتعاون معها وأن الأكاديمية تسعى لتطوير الرياضات البحرية في فلسطين.</p>
          <blockquote>
            <p>
          ...
          <div class="row">
             <div class="col-md-6 pt-0">
               <a href="assets/images/أكاديميات/تشامبيون1.jpg" class="gallery-thumb dark-overlay">
                <img src="assets/images/أكاديميات/تشامبيون1.jpg" alt="post"/>
              </a>
             </div>
             <div class="col-md-6">
               <a href="assets/images/أكاديميات/تشامبيون2.jpg" class="gallery-thumb dark-overlay">
                <img src="assets/images/أكاديميات/تشامبيون2.jpg" alt="post"/>
              </a>
             </div>
          </div>
          ...
          <div class="row">
             <div class="col-md-6 pt-0">
               <a href="assets/images/أكاديميات/تشامبيون3.jpg" class="gallery-thumb dark-overlay">
                <img src="assets/images/أكاديميات/تشامبيون3.jpg" alt="post"/>
              </a>
             </div>
             <div class="col-md-6">
               <a href="assets/images/أكاديميات/تشامبيون4.jpg" class="gallery-thumb dark-overlay">
                <img src="assets/images/أكاديميات/تشامبيون4.jpg" alt="post"/>
              </a>
             </div>
          </div>
          ...
          <aside class="col-lg-4">
              <div class="sidebar_wrap sidebar-2">
              <div class="sidebar_widget">
                <div class="widget_title">
                  <h4>تفاصيل الحدث</h4></div>
                  <div class="sigma_list-item">
                    <label>  الحدث : </label>
                    <span class="sigma_list-item">إتفاقية شراكة مع مجموعة تشامبيون</span>
                    <div class="sigma_list-item">
                    <label> الموقع : </label>
                    <span>مجموعة تشامبيون</span>
                    </div>
                    </div><div class="sigma_list-item">
                      <label>التاريخ : </label>
                 ...
                 <div class="sidebar_widget categories_widget">
                  ...
                  <ul>
                  <li>
                  <a href="./index.html">تصفح
                      <i class="fa fa-chevron-right"></i>
                  </a>
                  </li>
                     <li>
                      <a href="./portfolio.html">أحداث رياضية 
                          <i class="fa fa-chevron-right"></i>
                      </a>
                      </li>
                     <li>
                      <a href="./portfolio1.html">فعاليات إجتماعية 
                          <i class="fa fa-chevron-right"></i>
                      </a>
                      </li>
                  </ul>
