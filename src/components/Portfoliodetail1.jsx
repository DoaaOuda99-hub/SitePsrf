...
const Portfoliodetai1 = () => {
  ...
  return (
    <div>
          ...
          <meta name='description' content=' تفاصيل الأنشطة و الفعاليات الإجتماعية للإتحاد الفلسطيني للشراع و التجديف '></meta>
          <link rel='canonical' href={`/PortfolioDetail1/:${event.id}`}></link>
        </Helmet>
  ...
  <div class="sidebar_wrap sidebar-2">
     <div class="sidebar_widget">
      ...
      <div class="sidebar_widget categories_widget">
        ...
        <li>
        <Link to="./index.html">
        تصفح    <i class="fa fa-chevron-left"></i>
        </Link>
        </li>
           <li>
            <Link to="./portfolio.html">
            أحداث رياضية <i class="fa fa-chevron-left"></i>
            </Link>
            </li>
           <li>
            <Link to="./portfolio1.html">
            فعاليات إجتماعية <i class="fa fa-chevron-left"></i>
            </Link>
            </li>
        </ul>
     </div>
...
export default Portfoliodetai1;