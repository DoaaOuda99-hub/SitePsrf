...
const Gazaclub = () => {
  return (
    <div>
          ...
          <meta name='description' content='توقيع شراكة الإتحاد الفلسطيني للشراع و التجديف مع نادي غزة الرياضي لتأسيس أكاديمية تجديف  '></meta>
          <link rel='canonical' href='/gaza-club'></link>
        </Helmet>
...
{/* <!-- Subheader --> */}
<div id="inner_header" class="gazaclub bg-overlay"  data-parallax="scroll" data-image-src="assets/images/أكاديميات/gazaclub3.jpg">
<div class="container">
  <div class="inner_intro">
  <h1>نادي غزة الرياضي</h1>
  </div>
</div>
</div>
{/* <!-- /Subheader -->
   ...
   <div class="container">
      <div class="row">
        <div class="col-lg-8">
          ...
          <h4>توقيع الاتحاد الفلسطيني للشراع والتجديف اتفاقية شراكة مع نادي غزة الرياضي </h4>
          <p> جانب من توقيع رئيس  الاتحاد الفلسطيني للشراع والتجديف السيد خلدون ابوسليم  اتفاقية شراكة مع نادي غزة الرياضي لتأسيس اكاديمية التجديف بحضور السيد معاوية القواسمي عضو المكتب التنفيذي في اللجنة الاولمبية الفلسطينية والدكتور اسعد المجدلاوي نائب رئيس اللجنة الاولمبية الفلسطينية وممثلين عن بنك فلسطين الشريك الاستراتيجي مع الاتحاد.*
           *وشارك من النادي رئيس مجلس الإدارة الدكتور خالد الوادية، وأعضاء من مجلس إدارة نادي غزة الرياضي، الذي أشاد بالدور الذي تقوم به اللجنة الأولومبية الفلسطينية والاتحاد الفلسطيني للشراع والتجديف تجاه تطوير الرياضة البحريّة، مؤكّداً أنّ الشراكة مع الاتحاد ستوفر لهم الفرصة اللازمة لنشر ثقافة رياضة الشراع والتجديف بين الفئات المختلفة في المجتمع.</p> 
          <blockquote>
            <p>
          ...
          <div class="row">
             <div class="col-md-6 pt-0">
               <a href="assets/images/أكاديميات/gazaclub1.jpg" class="gallery-thumb dark-overlay">
                <img src="assets/images/أكاديميات/gazaclub1.jpg" alt="post"/>
              </a>
             </div>
             <div class="col-md-6">
               <a href="assets/images/أكاديميات/gazaclub2.jpg" class="gallery-thumb dark-overlay">
                <img src="assets/images/أكاديميات/gazaclub2.jpg" alt="post"/>
              </a>
             </div>
          </div>
          ...
          <div class="row">
             <div class="col-md-6 pt-0">
               <a href="assets/images/أكاديميات/gazaclub3.jpg" class="gallery-thumb dark-overlay">
                <img src="assets/images/أكاديميات/gazaclub3.jpg" alt="post"/>
              </a>
             </div>
             <div class="col-md-6">
              ...
              <div class="sidebar_widget">
                <div class="widget_title">
                  ...
                  <div class="sigma_list-item">
                    <label>  الحدث : </label>
                    <span class="sigma_list-item">إتفاقية شراكة مع نادي غزة الرياضي</span>
                    <div class="sigma_list-item">
                    <label> الموقع : </label>
                    <span>نادي غزة الرياضي</span>
                    </div>
