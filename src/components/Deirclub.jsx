  ...
  return (
    <div>
        <Helmet>
          ...
          <meta name='description' content='توقيع شراكة الإتحاد الفلسطيني للشراع و التجديف مع نادي دير البلح لتأسيس أكاديمية تجديف'></meta>
          <link rel='canonical' href='/deir-club'></link>
        </Helmet>
...
{/* <!-- Subheader --> */}
<div id="inner_header"class="deirclub bg-overlay"  data-parallax="scroll" data-image-src="assets/images/أكاديميات/Deirclub2.jpg">
<div class="container">
  <div class="inner_intro">
  <h1>نادي شباب دير البلح</h1>
  </div>
</div>
</div>
{/* <!-- /Subheader -->
   ...
   <div class="container">
      <div class="row">
        <div class="col-lg-8">
          ...
          <h4>توقيع الاتحاد الفلسطيني للشراع والتجديف اتفاقية شراكة مع نادي دير البلح  </h4> 

        <p>وقّع رئيس الاتحاد الفلسطيني للشراع والتجديف اتفاقية شراكة مع نادي شباب دير البلح لتأسيس أكاديمية التجديف بحضور السيد معاوية القواسمي عضو المكتب التنفيذي في اللجنة الاولمبية الفلسطينية والدكتور اسعد المجدلاوي نائب رئيس اللجنة الاولمبية الفلسطينية وممثلين عن بنك فلسطين الشريك الاستراتيجي مع الاتحاد.</p>
          ...
          <div class="row">
             <div class="col-md-6 pt-0">
               <a href="assets/images/أكاديميات/Deirclub1.jpg" class="gallery-thumb dark-overlay">
                <img src="assets/images/أكاديميات/Deirclub1.jpg" alt="post"/>
              </a>
             </div>
             <div class="col-md-6">
               <a href="assets/images/أكاديميات/Deirclub2.jpg" class="gallery-thumb dark-overlay">
                <img src="assets/images/أكاديميات/Deirclub2.jpg" alt="post"/>
              </a>
             </div>
          </div>
              ...
              <div class="sidebar_widget">
                <div class="widget_title">
                  ...
                  <div class="sigma_list-item">
                    <label>  الحدث : </label>
                    <span class="sigma_list-item">إتفاقية شراكة مع نادي شباب دير البلح</span>
                    <div class="sigma_list-item">
                    <label> الموقع : </label>
                    <span>نادي شباب دير البلح</span>
                    </div>
